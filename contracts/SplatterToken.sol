...
contract SplatterToken is Ownable, ERC721A {
    ...
    /**
     */
    constructor(address _developer, IProxyRegistry _proxyRegistry)
    ...
    function _generateTraits(uint256 _tokenId)
        internal
        view
        ...
        returns (string memory)
    {
        ...
        bytes memory image = bytes(
            generateSVG(svgPart, _tokenId % _tokensPerAsset, "xxx")
        );
